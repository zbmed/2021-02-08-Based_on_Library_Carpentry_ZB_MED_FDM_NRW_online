...
venue: "Based on Library Carpentry @ fdm.nrw - ONLINE"         # brief name of host site without address (e.g., "Euphoric State University")
...
collaborative_notes: https://pad.gwdg.de/sqVKbtjyT669fRO-_zIOTg  # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
